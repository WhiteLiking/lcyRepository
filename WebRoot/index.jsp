<%@ page language="java" import="com.vo.ShopCar,java.util.*" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
		...
		<div id="tabhead" class="tab-head">
			...
			<%  List<ShopCar> shopCar = (List<ShopCar>)session.getAttribute("shopCar"); 
		     		...
		     		for(int i=0;i<shopCar.size();i++){
		     			...
		     			orderNumber = orderNumber+shopCar.get(i).getCid();
		     			allcdec = allcdec+shopCar.get(i).getCdec();
		     		}
		     		%>
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject"  value="聚美客户商品订单" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="<%=allcdec %>"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
		...
		<form name=traderefundquery
			...
			<div id="body4" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDRQout_trade_no" name="WIDRQout_trade_no" value=""/>
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
